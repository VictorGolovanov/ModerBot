...
public class Censor {
    ...
    // хуй           (н    [иеа]     |([дп]     | верт)                   о   |ра         [зс]   |з?а| с   (ме  )   ?| о    (т   | д   но)      ?| а   п   ч| пере                 | при              | в )  ?-? корень хуй  ([яйиеёю]     | ли      (?!о|ган)).*?|
                  ...
                  "|([сs]+[тtm]+[рrp]+[аa]+[хhx]+[оo0]+|[вv][зz3ыyui]|[.]*жды|(н|сук)а)?-?[бb]+[лl]+([я]+(?!(х|ш[кн]|мб)[ауеыио]).*?|[ay@еeэe]+[дd9тtm]ь?)" +
    // бля                                               (в  [зы]     |[.]*жды|(н|сук)а)?-?корень бля(я (?!(х|ш[кн]|мб)[ауеыио]).*?|[еэ]  [дт]    ь?)|( ра[сз]             |[зн]      а   |[со]    | в    ы?   | п(ере                 | р    [оие]     | о     д)    | и   [зс]    ъ?|[ао]    т   | д     о)?     п    [иеё]+    з     д    .*?| (за )
                  ...
                  "|([рrp]+[аa]+[сscзz3]+|[зz3нnh]+[аa]+|[сscоo0]|[вv]+[ыuy]?|[пpn]+([еe]+[рrp]+[еe]+|[рrp]+[оo0иiuеe]|[оo0]+[дd9]+)|[иiu][зz3сsc]ъ?|[аaоo0][тtm]|[дd9]+[оo0]+)?[пpn]+[иiuеёe]+[зz3]+[дd9]+.*?" +
    // пизд        |( ра[сз]             |[зн]      а   |[со]    | в    ы?   | п(ере                 | р    [оие]     | о     д)    | и   [зс]    ъ?|[ао]    т   | д     о)?     п[иеё]+зд                .*?|
