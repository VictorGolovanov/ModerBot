...
public class Censor {
    ...
    public static boolean censor(Message message) {
        if (filterEmoji(message)) {
            return true;
        } else {
    ...
    public static boolean filterText(String text) {
    ...
    public static boolean filterEmoji(Message message) {
