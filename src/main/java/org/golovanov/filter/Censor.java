...
public class Censor {
    ...
    private static final Pattern megaPattern = Pattern.compile("(?iu)\\b(([уyu]+|[нзnz3]+[аa]+|([хhиiтtрrоo]+|[нnеe]+)?[вvb]+[зz3]?[ыyьъi']+|[сsc]+[ьъy'`]|([иiu]|[рr]+[аa]+)[зz3сsc]ъ*|([оo][тtбb]|[пp][оo0][дd])[ьъ]?|(.\\B)+?[оoаaеeиiu]+)?-?([еёe]+[бb]+(?!о[рй])|[иiu]+[бb]+[аaеe]+[тtmцc]+).*?|([нn]+[иiuеeаa]+|([дd9пpn]+|[вv]+[еe]+[рrp]+[тtm]+)[оo0]+|[рrp][аa]+[зz3сs]+|з?а|[сs]([мm][еe])?|[оo0]([тtm]|[дd][нn][оo0])?|[аa][пpn]ч|[пpn]+[еe]+[рrp]+[еe]+|[пpn]+[рrp]+[иiu]+|[вv]+)?-?[хxh]+[уyu]+([яйiyиiuеёeюu]|[лl]+[иiu]+(?!о|ган)).*?|([сs]+[тtm]+[рrp]+[аa]+[хhx]+[оo0]+|[вv][зz3ыyui]|[.]*жды|(н|сук)а)?-?[бb]+[лl]+(я+(?!(х|ш[кн]|мб)[ауеыио]).*?|[@еeэe]+[дd9тtm]ь?)|([рrp]+[аa]+[сscзz3]+|[зz3нnh]+[аa]+|[сscоo0]|[вv]+[ыuy]?|[пpn]+([еe]+[рrp]+[еe]+|[рrp]+[оo0иiuеe]|[оo0]+[дd9]+)|[иiu][зz3сsc]ъ?|[аaоo0][тtm]|[дd9]+[оo0]+)?[пpn]+[иiuеёe]+[зz3]+[дd9]+.*?|([зz3]+[аa]+)?[пpn]+[иiuеe]+[дd9][аaоo0еeё]*[рrp]+.*([нn]+[уy]+.*?|[оo0аa]+[мm]+|([аa]+[сsc]+)?([иiu]+([лl]+[иiu]+)?[нnщкkтtmлl]ь?)?|([оo0]+(ч[еeиiu])?|[аa]+[сsc])?[кk]+([оo0]+[йiy]+)|[юu]+[гgr]+)[аaуyеeыu]?|[мm]+[аa]+[нnh]+[дd9]+(([аaуyеeыuиiо0o])+([лl]+([иiu]+[сscзz3щ]+)?[аaуyuеeиiы]*)?|[оo0]+[йiu]+|[аaоo0][вvb]+[оo0]+шь?([еe]?[кk]+[аaуyеe])?|[юu]+[кk]+([оo0]+[вvb]+|[аaуyиiu])?)|[мm]+[уyu]+[дd9]+([яаaиiuоo0].*?|[еe]?[нn]+([ьюиiuя]|[еe]+[йiu]))|[мm]+[лl]+[яya]+([тtmдd9]ь)?|[лl]+[яya]+[тtm]+ь|([нnзz3]+[аa]+|[пpn]+[оo0]+)[хxh]+|[мm]+[аaоo0]+[лl]+[аaоo0]+ф+ь+([яиiuю]+|[еёeоo0]+[йiu]+)|([еe]+[лl]+[дd9]+[аa]*.*))\\b");
    // для удобства                                                   "(?iu)\\b((у    |[нз]     а   |  (хитро      |не     )?  в     з  ?[ыьъ]    | с    [ьъ]   | (и   | ра )       [зс]  ъ? | (о  [тб]  | под)         [ьъ]?|(.\\B)+?[  оаеи] )   ?-?(корень еб  (?!о[рй])|  и   [б]  [ае]   [тц])    .*?|(н    [иеа]     |([дп]     | верт)                   о   |ра         [зс]   |з?а| с   (ме  )   ?| о    (т   | д   но)      ?| а   п   ч| пере                 | при              | в )  ?-? корень хуй  ([яйиеёю]     | ли        (?!о|ган)).*?|                                    (в  [зы]     |[.]*жды|(н|сук)а)?-?корень бля(я (?!(х|ш[кн]|мб)[ауеыио]).*?|[еэ]  [дт]    ь?)|( ра[сз]             |[зн]      а   |[со]    | в    ы?   | п(ере                 | р    [оие]     | о     д)    | и   [зс]    ъ?|[ао]    т   | д     о)?     п    [иеё]+    з     д    .*?| (за )       ?корень пидор п[ие]д[аое]?      р      ( ну       .*?|[оа]     м   |( ас)?         (и(ли)?             [нщктл]     ь?)?|( о    (ч[еи])?   | ас)?         к    (ой)        | юг)    [ауеы]?        |корень манда          ([ауеыи]     ( л(и         [сзщ])?     [ауеиы])?      | о     й    |[ао]    в     о    шь?( е?   к   [ауе])?   | ю    к   (  о     в   |[ауи])?)    | м     у     д   ([яаио]     .*?|е?   н    ([ьюия]  | е    й  )) |       мля     ([тд]ь)?     |     лять         |([нз]      а  |      по    )  х   | м   [ао]     л   [ао]     фь ([яию]   |[еёо]     й)    |(  елд[а]?.*))            \\b");
